...
const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/dashboard/business-categories', label: 'Business categories', icon: 'collections' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/dashboard/integrations', label: 'Integrations', icon: 'integrations', roles: ['admin'] },
